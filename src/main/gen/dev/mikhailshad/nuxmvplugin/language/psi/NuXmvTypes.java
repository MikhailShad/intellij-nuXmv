...
public interface NuXmvTypes {
    ...
    IElementType ABS_FUN = new NuXmvTokenType("abs");
    IElementType ACOS_FUN = new NuXmvTokenType("acos");
    ...
    IElementType ASIN_FUN = new NuXmvTokenType("asin");
    ...
    IElementType COMPID_KW = new NuXmvTokenType("COMPID");
    IElementType COMPUTE_KW = new NuXmvTokenType("COMPUTE");
    IElementType COMPWFF_KW = new NuXmvTokenType("COMPWFF");
    IElementType CONCAT = new NuXmvTokenType("::");
    IElementType CONSTANTS_KW = new NuXmvTokenType("CONSTANTS");
    IElementType CONSTARRAY_FUN = new NuXmvTokenType("CONSTARRAY");
    ...
    IElementType CTL_EXISTS_GLOBALLY = new NuXmvTokenType("EG");
    IElementType CTL_EXISTS_NEXT = new NuXmvTokenType("EX");
    IElementType CTL_FORALL = new NuXmvTokenType("A");
    IElementType CTL_FORALL_FINALLY = new NuXmvTokenType("AF");
    IElementType CTL_FORALL_GLOBALLY = new NuXmvTokenType("AX");
    IElementType CTL_FORALL_NEXT = new NuXmvTokenType("AG");
    ...
    IElementType LTL_FINALLY = new NuXmvTokenType("F");
    IElementType LTL_GLOBALLY = new NuXmvTokenType("G");
    IElementType LTL_HISTORICALLY = new NuXmvTokenType("H");
    IElementType LTL_NEXT = new NuXmvTokenType("X");
    IElementType LTL_NOT_PREVIOUS = new NuXmvTokenType("Z");
    IElementType LTL_ONCE = new NuXmvTokenType("O");
    IElementType LTL_PREVIOUS = new NuXmvTokenType("Y");
    IElementType LTL_RELEASES = new NuXmvTokenType("V");
    IElementType LTL_SINCE = new NuXmvTokenType("S");
    ...
    IElementType MIN_FUN = new NuXmvTokenType("min");
    ...
    IElementType NEXTWFF_KW = new NuXmvTokenType("NEXTWFF");
    IElementType NEXT_FUN = new NuXmvTokenType("next");
    IElementType NONCONTINUOUS_KW = new NuXmvTokenType("noncontinuous");
    ...
    IElementType READ_FUN = new NuXmvTokenType("READ");
    IElementType REAL_KW = new NuXmvTokenType("Real");
    IElementType REAL_TYPE = new NuXmvTokenType("real");
    IElementType RESIZE_FUN = new NuXmvTokenType("resize");
    IElementType RPAREN = new NuXmvTokenType(")");
    IElementType RTCTL_ABF = new NuXmvTokenType("ABF");
    IElementType RTCTL_ABG = new NuXmvTokenType("ABG");
    IElementType RTCTL_BU = new NuXmvTokenType("BU");
    ...
    IElementType TL_UNTIL = new NuXmvTokenType("U");
    IElementType TO_BOOL_FUN = new NuXmvTokenType("bool");
    IElementType TO_INT_FUN = new NuXmvTokenType("toint");
    IElementType TO_SIGNED_FUN = new NuXmvTokenType("signed");
    IElementType TO_SIGNED_WORD_FUN = new NuXmvTokenType("signed word[N]");
    IElementType TO_UNSIGNED_FUN = new NuXmvTokenType("unsigned");
