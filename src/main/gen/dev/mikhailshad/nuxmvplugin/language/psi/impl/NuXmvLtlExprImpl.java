...
public class NuXmvLtlExprImpl extends ASTWrapperPsiElement implements NuXmvLtlExpr {

    public NuXmvLtlExprImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull NuXmvVisitor visitor) {
        visitor.visitLtlExpr(this);
    }
