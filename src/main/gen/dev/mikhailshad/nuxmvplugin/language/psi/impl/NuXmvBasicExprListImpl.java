...
public class NuXmvBasicExprListImpl extends ASTWrapperPsiElement implements NuXmvBasicExprList {

    public NuXmvBasicExprListImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull NuXmvVisitor visitor) {
        visitor.visitBasicExprList(this);
    }
