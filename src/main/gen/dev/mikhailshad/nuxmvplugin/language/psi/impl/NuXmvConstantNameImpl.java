...
import dev.mikhailshad.nuxmvplugin.language.psi.NuXmvConstantName;
...
public class NuXmvConstantNameImpl extends NuXmvNamedElementMixin implements NuXmvConstantName {

    public NuXmvConstantNameImpl(@NotNull ASTNode node) {
        super(node);
    }
