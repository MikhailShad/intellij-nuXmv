...
public class NuXmvUntilCtlExprImpl extends NuXmvExprImpl implements NuXmvUntilCtlExpr {

    public NuXmvUntilCtlExprImpl(@NotNull ASTNode node) {
        super(node);
    }

    @Override
    public void accept(@NotNull NuXmvVisitor visitor) {
        visitor.visitUntilCtlExpr(this);
    }
