...
public class NuXmvCompassionConstraintImpl extends ASTWrapperPsiElement implements NuXmvCompassionConstraint {

    public NuXmvCompassionConstraintImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull NuXmvVisitor visitor) {
        visitor.visitCompassionConstraint(this);
    }
