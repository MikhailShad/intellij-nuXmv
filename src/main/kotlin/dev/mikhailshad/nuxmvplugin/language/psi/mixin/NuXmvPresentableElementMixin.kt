...
abstract class NuXmvPresentableElementMixin(node: ASTNode) : ASTWrapperPsiElement(node), NuXmvPresentableElement {
    override fun getPresentation(): ItemPresentation {
        return object : ItemPresentation {
            override fun getPresentableText(): String? = text

            override fun getIcon(unused: Boolean): Icon = NuXmvIcons.FILE
        }
    }
}
